...
public class Quad {
   ...
   * @param _ul upper left corner
   */
  public Quad(Matrix<N4, N1> _ll, Matrix<N4, N1> _lr, Matrix<N4, N1> _ur, Matrix<N4, N1> _ul) {
    ll = VecBuilder.fill(_ll.get(0, 0), _ll.get(1, 0), _ll.get(2, 0), _ll.get(3, 0));
    lr = VecBuilder.fill(_lr.get(0, 0), _lr.get(1, 0), _lr.get(2, 0), _lr.get(3, 0));
    ul = VecBuilder.fill(_ul.get(0, 0), _ul.get(1, 0), _ul.get(2, 0), _ul.get(3, 0));
    ur = VecBuilder.fill(_ur.get(0, 0), _ur.get(1, 0), _ur.get(2, 0), _ur.get(3, 0));
  }
