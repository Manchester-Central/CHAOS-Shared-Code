...
/**
 * A utility class to calculate release vectors. Most functions are static and state-less.
 * In another language, like C++, we would probably toss this in a namespace instead.
 */
public class Ballistics {
     ...
     * must be in a consistent coordinate frame. Either stick in field coordinates, or
     * derive robot relative coordinates.
     * 
     * <p>Note that because this ignores air resistance, it is not a full physics model,
     * but it should be accurate enough in most game scenarios if the mechanical team
     * designed their system well.
     * 
     ...
     * 
     * All points must be in a consistent coordinate frame. Either stick in field coordinates,
     * or derive robot relative coordinates.
     * 
     * <p>Note that because this ignores air resistance, it is not a full physics model,
     * but it should be accurate enough in most game scenarios if the mechanical team
     * designed their system well. Any resistance and resulting "falling short" will
     * hopefully be compensated by any bouncing that happens once it hits the ground.
     * 
     * @param release_position the coordinate of the release point, not the robot pose
     * @param target_position the coordinate of the target point we want the ballistic to reach
     * @param robot_velocity the speed of the robot at that instant
