...
/**
 * A Logged Dashboard number specific for PID Values. This is useful for tracking PID values during testing,
 * but should be replaced with a basic PID structure once settled. Extends the PIDTuner to make it easier to
...
public class LoggedPIDTuner extends PIDTuner {
     ...
     */
    public LoggedPIDTuner(String key, double _p, double _i, double _d, Consumer<PIDFValue> pidfUpdater) {
     ...
     * @param pidfUpdater callback function to update a device when the values change
     */
    public LoggedPIDTuner(String key, double _p, double _i, double _d, double _f, Consumer<PIDFValue> pidfUpdater) {
