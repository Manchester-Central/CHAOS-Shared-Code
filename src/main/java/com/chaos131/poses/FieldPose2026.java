...
public class FieldPose2026 extends PivotedFieldPose {
  ...
  public static final Translation3d BlueClimbFarLeft = new Translation3d(Inches.of(41.8), Inches.of(123.96), Inches.of(0));
  public static final Translation3d BlueClimbLeft = new Translation3d(Inches.of(43.367), Inches.of(130.5), Inches.of(0));
  public static final Translation3d BlueClimbMiddle = new Translation3d(Inches.of(41.8), Inches.of(146.86), Inches.of(0));
  public static final Translation3d BlueClimbRight = new Translation3d(Inches.of(43.367), Inches.of(164.4), Inches.of(0));
  public static final Translation3d BlueClimbFarRight = new Translation3d(Inches.of(41.8), Inches.of(170.96), Inches.of(0));
  ...
  public static void initializeFieldPoses() throws IOException {
    ...
    // Climber positions
    ClimbFarLeftBar = new FieldPose2026(Alliance.Blue, "FarLeftClimb", new Pose3d(BlueClimbFarLeft, new Rotation3d()));
    ClimbLeftBar = new FieldPose2026(Alliance.Blue, "LeftClimb", new Pose3d(BlueClimbLeft, new Rotation3d()));
    ClimbMiddle = new FieldPose2026(Alliance.Blue, "MiddleClimb", new Pose3d(BlueClimbMiddle, new Rotation3d()));
    ClimbRightBar = new FieldPose2026(Alliance.Blue, "RightClimb", new Pose3d(BlueClimbRight, new Rotation3d()));
    ClimbFarLeftBar = new FieldPose2026(Alliance.Blue, "FarRightClimb", new Pose3d(BlueClimbFarRight, new Rotation3d()));
  }
}
