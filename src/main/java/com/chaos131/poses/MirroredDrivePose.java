...
public abstract class MirroredDrivePose {
     ...
     * By default, the pose is initialized for blue, and will mirror the pose to red when on the red alliance.
    ...
    public static MirroredDrivePose makeWPIBluePoseFromCenteredPose(Matrix<N4, N1> pt,
        ...
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'makeWPIBluePoseFromCenteredPose'");
    }
}
