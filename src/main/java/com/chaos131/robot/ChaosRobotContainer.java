...
/** Base robot container that accompanies ChaosRobot, and contains many data structures and methods that are common across seasons and projects. */
public abstract class ChaosRobotContainer {
    ...
    /**
     * Attempts to update the pose estimator within the swerve drive object. Note that
     * the SwerveDrive may disregard pose updates if 
