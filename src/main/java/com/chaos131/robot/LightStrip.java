...
/**
 * Class that manages addressable LEDs. Does not do any patterns, sets all LEDs to the same color.
 */
public class LightStrip extends SubsystemBase {
   ...
   * @param num_leds number of LEDs we will manage (must be less than or equal to the actual number
   *     of leds)
